...
const EditProductsPage = () => {
  ...
  const [uploading, setUploading] = React.useState(false); // State to track file upload status
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-4 mt-4">
                    {productData.images.map((image, index) => (
                        <div key={index}>
                            <img src={image.url} alt={image.alt} className="w-20 h-20 object-cover rounded-md shadow-md" />
                        </div>
                    ))}
                </div>
            </div>

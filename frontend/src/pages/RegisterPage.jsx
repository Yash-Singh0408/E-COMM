  ...
  return (
    <div className="flex">
         <div className="w-full md:w-1/2 h-screen bg-gray-200 flex flex-col items-center justify-center p-8 md:p-12">
            ...
            <div className="hidden md:block w-1/2 h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')" }}>
            </div>
        </div>
  )
}

      ...
      <div className="hidden md:flex w-1/2 bg-[#141414] border-r border-[#2a2a2a] items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["Exclusive Access", "Member Benefits", "Premium Support"].map(
              (feature, index) => (
                <motion.div
                  key={index}
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#0b0b0b] border border-[#2a2a2a] rounded-sm py-3 pl-11 pr-4 text-[#f5f5f5] placeholder-[#b3b3b3] focus:outline-none focus:border-[#d6a354]"
                />
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#0b0b0b] border border-[#2a2a2a] rounded-sm py-3 pl-11 pr-11 text-[#f5f5f5] placeholder-[#b3b3b3] focus:outline-none focus:border-[#d6a354]"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#b3b3b3] hover:text-[#d6a354] transition-colors"
                >
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={`w-full bg-[#0b0b0b] border rounded-sm py-3 pl-11 pr-11 text-[#f5f5f5] placeholder-[#b3b3b3] focus:outline-none transition-colors ${
                    !passwordMatch
                      ? "border-red-500 focus:border-red-500"
                      : "border-[#2a2a2a] focus:border-[#d6a354]"
                  }`}
                />
                <button
                  type="button"
